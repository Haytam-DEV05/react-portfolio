    ...
    <section id="home" className="fade-in mb-7">
      <div className="container md:flex flex-row justify-between items-center">
        <div className="left">
          ...
          <h2 className="text-[28px] md:my-8">Full-Stack / Web Developer</h2>
          <p className="md:max-w-125">
          ...
          <div className="flex flex-col buttons my-3 md:flex-row gap-x-10 gap-y-3">
              <a
                className="bg-(--primary) px-2 py-1 cursor-pointer rounded-2xl text-white text-center"
                href="/cv/Haitam_Nefal_CV.pdf"
            ...
            <NavLink
              ...
              className="bg-(--primary) px-5 py-1.5 cursor-pointer rounded-2xl text-center text-white"
              to="/Contact"
            >
              Contact Me
            </NavLink>
