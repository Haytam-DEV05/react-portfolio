...
export default function Footer() {
  return (
    <footer
      id="footer"
      className="container py-5 text-center md:flex justify-between items-center border-t-2 border-(--soft)"
    >
      <p>
      ...
      <ul className="flex gap-6 socials">
        {socialIcons.map((ele) => (
          <li
            key={ele.id}
            className="cursor-pointer max-w-fit mx-auto my-2 hover:text-(--primary) transition-colors duration-200"
          >
